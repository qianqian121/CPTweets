...
//        Toast.makeText(getApplicationContext(), "JSON request", Toast.LENGTH_SHORT).show();
        ...
        client.getMentionsTimeline(new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONArray response) {
                client.unlock();
                Toast.makeText(getActivity(), "MentionsTimeline Fragment JSON success", Toast.LENGTH_SHORT).show();
...
//                swipeContainer.setRefreshing(false);
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                client.unlock();
                Toast.makeText(getActivity(), "MentionsTimeline Fragment JSON failure", Toast.LENGTH_SHORT).show();
